    ...
    node ('gradlePod') {
        ...
        container('kubectl') {
            stage('Deploy new Docker Image') {
                ...
                ./linux-amd64/helm install --tls -n bluecompute-customer --set image.repository=\${REGISTRY}/\${NAMESPACE}/bluecompute-customer --set image.tag=${env.BUILD_NUMBER} bluecompute/customer
                """
            }
        }
    }
